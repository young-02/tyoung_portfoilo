                        ...
                        <form action="boardModifySave.php" name="boardWrite" method="post">
                            <fieldset>
                                ...
                                <div>
                                    ...
                                    <textarea type="text" name = "boardContent" id="boardContent" row="13" class="title-text"></textarea>
                                </div>
                                <div class="mt20">
                                    <label for="boardPass">비밀번호</label>
                                    <input type="password" name = "boardPass" id="boardPass"  class="title-text" placeholder="로그인해주세요" >
                                </div> -->
                            </fieldset>
