                    ...
                    <section class="board">
                        <table>
                            ...
                            <?php
                                    ...
                                    //$sql = "SELECT b.boardID, b.boardTittle, b.boardContent, b.boardView, m.youName, b.regTime FROM myBoard b  JOIN myMemeber m ON (m.memberID = b.memberID) WHERE b.boardTittle LIKE '%{$searchKeyword}%'";
                                    //$sql = "SELECT b.boardID, b.boardTittle, b.boardContent, b.boardView, m.youName, b.regTime FROM myBoard b  JOIN myMemeber m ON (m.memberID = b.memberID) WHERE b.boardContent LIKE '%{$searchOption}%'";
                                    ...
                                    switch($searchOption){
                                        case 'title':
                                             $sql .= " WHERE b.boardTittle LIKE '%{$searchKeyword}%' ORDER BY boardID DESC LIMIT 10";
                                             break;
                                        case 'content':
